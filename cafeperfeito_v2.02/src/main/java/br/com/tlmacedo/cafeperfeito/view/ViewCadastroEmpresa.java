...
public class ViewCadastroEmpresa {
    ...
    public Tab tabCadastroEmpresa(String titulo) {
        setTitulo(titulo);
        Parent parent;
        try {
            parent = FXMLLoader.load(getClass().getResource(TCONFIG.getFxml().getCadastroEmpresa().getFxml()));
    ...
    public static void setTitulo(String titulo) {
        ViewCadastroEmpresa.titulo = titulo;
    }
